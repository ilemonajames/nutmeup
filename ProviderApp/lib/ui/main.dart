...
import 'package:nutmeup/model/model.dart';
import 'package:nutmeup/ui/chat2.dart';
import 'package:nutmeup/ui/documents.dart';
import 'package:nutmeup/ui/products/products.dart';
import 'package:nutmeup/ui/service/services.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
          ...
          if (state == "booking" || state == "chat" || state == "subscription_plan" || state == "account"){
            _dialogName = "exit";
            _show = 1;
            _redraw();
            return false;
            ...
            Container(
              ...
              child: BottomBar13(colorBackground: (theme.darkMode) ? Colors.black : Colors.white,
                  ...
                  callback: (int y){
                    ...
                    if (y == 3) state = "subscription_plan";
                    setState(() {
                    });
