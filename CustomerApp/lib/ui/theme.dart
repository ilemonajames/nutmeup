...
class AppTheme implements DefaultTheme{
  ...
  @override
  Color mainColor = Colors.blueGrey;//Colors.blueGrey;
  ...
  Color splashColor = Colors.blueGrey;//Color(0xff1c7bab);
  // lang
  ...
  AppTheme(bool _dartMode, {
    this.mainColor =  Colors.blueGrey,//Colors.blueGrey,
    ...
    this.splashColor = Colors.blueGrey,//const Color(0xff1c7bab),
    // lang
    ...
    style13W400U = TextStyle(fontFamily: _font, letterSpacing: 0.4,
  ...
  factory AppTheme.fromJson(Map<String, dynamic> data){
    return AppTheme(
      ...
      mainColor: (data["mainColor"] != null) ? getColor(data["mainColor"]) : Colors.blueGrey,
      ...
      splashColor : (data["splashColor"] != null) ? getColor(data["splashColor"]) : Colors.blueGrey,//Color(0xff1c7bab),
      // lang
  ...
  TextStyle style13W800Blue = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 13, fontWeight: FontWeight.w800, color: Colors.blueGrey);
  ...
  TextStyle style16W800Blue = TextStyle(fontFamily: _font, letterSpacing: 0.6,
      fontSize: 16, fontWeight: FontWeight.w800, color: Colors.blueGrey);
