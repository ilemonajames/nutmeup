            ...
            Container(
              ...
              child: BottomBar13(colorBackground: (theme.darkMode) ? Colors.black : Colors.white,
                  ...
                  getItem: (){
                    ...
                    if (state == "repair") return 1;
                    if (state == "spare_parts") return 2;
                    // if (_state == "cart") return 2;
                    if (state == "booking") return 3;
                    if (state == "account") return 4;
                  },
                  text: [strings.get(6), // "Home",
                    "Repair",//strings.get(8), // "Booking",
                    // strings.get(268), // "Cart",
                    "Spare Parts",//strings.get(7), // "Chat",
                    "Booking",//strings.get(96), // "Notify",
