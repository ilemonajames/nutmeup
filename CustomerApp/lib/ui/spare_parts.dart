  ...
  _titleSmall() {
    return Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              !_mainModel.searchActivate ? "Products" : strings.get(122), /// "Home services", // "Search",
              style: theme.style16W800,),
            SizedBox(height: 3,),
            Text("Buy or sell quality products with ease", // Find what you need
    ...
    for (var item in appSettings.customerAppElements) {
      ...
      if (item == "related_products"){
        list.add(Container(
            ...
            child: Row(
              children: [
                Expanded(child: Text("Sellect a product to view details", /// "Related products",
